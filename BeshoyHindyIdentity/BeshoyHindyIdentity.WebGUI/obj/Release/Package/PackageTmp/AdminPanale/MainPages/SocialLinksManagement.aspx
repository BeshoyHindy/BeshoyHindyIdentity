<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="SocialLinksManagement.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.SocialLinksManagement" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="form-label">Social Link Title :.</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtTitle" CssClass="form-control " runat="server" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Social Link Logo (font-awsom icon name) :.</label>
                                    <div class="controls">

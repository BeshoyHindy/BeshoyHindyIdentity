<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="EducationList.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.EducationList" %>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="btnEdit" runat="server"
                                                            CssClass="btn btn-default btn-sm btn-small"
                                                            NavigateUrl='<%#"~/AdminPanale/MainPages/EducationMaganagement.aspx?ID="+Eval("id")%>'
                                                            data-toggle="tooltip"
                                                            title="Edit Item"
                                                            data-placement="bottom"
                                                            Text="Edit">

<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="ClientsManagement.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.ClientsManagement" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtClientName" CssClass="form-control " runat="server" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Client Position :.</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtClientPosition" CssClass="form-control " runat="server" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <asp:TextBox ID="txtClientURL" CssClass="form-control " runat="server" />
                                </div>
                            </div>
                            <!--image here-->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <asp:TextBox ID="txtClientMessage" TextMode="MultiLine" Rows="4" CssClass="form-control " runat="server" />
                                </div>
                            </div>

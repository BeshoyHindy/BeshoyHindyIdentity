...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="img/ico-16.png" />
                        ...
                        <ItemTemplate>
                            <div class="col-md-4 clearfix">
                                <div class="services-box new-line item_right">
                                    ...
                                    <div class="services-box-icon">
                                        <i class="fa <%#Eval("Image").ToString() %> fa-3x"></i>
                                    </div>
                                    <div class="service-box-info">
                                        <p>
                            ...
                            <asp:Repeater ID="rptrWorks" runat="server">
                                <ItemTemplate>
                                    <article class='<%#Eval("WorkTypeId").ToString() %>'>
                                        <a href='#!projects/ProjectDetails.aspx?PID=<%#Eval("Id").ToString() %>'>
                                            <img src='<%#ConfigurationManager.AppSettings["PortfolioUI"].ToString() + Eval("IamgeThumb") %>' alt="Portfolio" />
                                            <div class="overlay">
                                                <div class="item-info">
        ...
        <div class="fullwidth-section bg-callout">
            <div class="container">
                <div class="col-md-12 text-center item_bottom">
                    ...
                    <a href="#contact" class="scroll btn btn-trans btn-border-w btn-large">Hire Me</a>&nbsp;&nbsp;<a class="btn btn-primary btn-lg" target="_blank" id="ancrReusmeURL" runat="server"><i class="fa fa-download"></i> Download Resume</a>
                </div>
            </div>
        </div>
                ...
                <div class="row item_fade_in">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="name" id="txtName" class="form-control required" placeholder="Name" runat="server" />

                        </div>
                        <div class="form-group">
                            <input type="email" name="email" id="txtEmail" class="form-control required email" placeholder="Email" runat="server" />
                        </div>
                        <div class="form-group">
                            <textarea name="message" id="txtMessage" class="form-control input-lg required" rows="9" placeholder="Enter Message" runat="server"></textarea>
                        </div>

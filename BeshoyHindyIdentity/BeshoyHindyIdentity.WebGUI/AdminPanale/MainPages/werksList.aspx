<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="werksList.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.werksList" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <label class="form-label">Choose Work Type :.</label>
                                        <div class="controls">
                                            <asp:DropDownList CssClass="select2-choices" Width="400px" ID="ddlWorkType" AutoPostBack="True" runat="server" OnSelectedIndexChanged="ddlWorkType_SelectedIndexChanged">
                                            </asp:DropDownList>
                                            <asp:ObjectDataSource ID="odsWorkTypes" runat="server" SelectMethod="LoadWorksTypes" TypeName="DAL.Repositories.WorkTypeRepository"></asp:ObjectDataSource>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <asp:GridView ID="grdData"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="Title" HeaderText="Work Title" SortExpression="Title">
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="btnEdit" runat="server"
                                                            CssClass="btn btn-default btn-sm btn-small"
                                                            NavigateUrl='<%#"~/AdminPanale/MainPages/WorksMaganagement.aspx?ID="+Eval("id")%>'
                                                            data-toggle="tooltip"
                                                            title="Edit Item"
                                                            data-placement="bottom"
                                                            Text="Edit">

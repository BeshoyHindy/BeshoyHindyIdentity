...
namespace WebGUI.AdminPanale.MainPages
{
    public partial class ClientsList : System.Web.UI.Page
    {
        ...
        {
            MasterPages.Pages.PageTitle = "Cliets";   // Set page title

            ClientRepository _ClientRepository = new ClientRepository();

            grdData.DataSource = _ClientRepository.LoadByActiveState(true);
            grdData.DataBind();
        }
        ...
        {
            ClientRepository _Obj = new ClientRepository();
        ...
        {
            Response.Redirect("~/AdminPanale/MainPages/ClientsManagement.aspx");
        }

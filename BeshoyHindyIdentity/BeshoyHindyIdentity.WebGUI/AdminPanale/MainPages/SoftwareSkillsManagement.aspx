<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="SoftwareSkillsManagement.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.SoftwareSkillsManagement" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtPercentage" CssClass="form-control " runat="server" />
                                    </div>
                                </div>
                                <div class="form-group">

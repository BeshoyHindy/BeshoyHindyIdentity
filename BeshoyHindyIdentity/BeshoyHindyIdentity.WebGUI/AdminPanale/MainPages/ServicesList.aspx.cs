...
namespace WebGUI.AdminPanale.MainPages
{
    public partial class ServicesList : System.Web.UI.Page
    {
        ...
        {
            MasterPages.Pages.PageTitle = "Services";   // Set page title

            ServicesRepository _ServicesRepository = new ServicesRepository();

            grdData.DataSource = _ServicesRepository.LoadByActiveState(true);
            grdData.DataBind();
        }
        ...
        {
            ServicesRepository _Obj = new ServicesRepository();

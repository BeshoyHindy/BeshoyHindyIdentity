<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="ContactManagement.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.ContactManagement" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtAddress" TextMode="MultiLine" Rows="3" CssClass="form-control " runat="server" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtGoogleMap" TextMode="MultiLine" Rows="4" CssClass="form-control " runat="server" />
                                    </div>
                                </div>

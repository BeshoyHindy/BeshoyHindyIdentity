...
namespace WebGUI.AdminPanale.MainPages
{
    public partial class ResumeList : System.Web.UI.Page
    {
        ...
        {
            MasterPages.Pages.PageTitle = "Resumes";   // Set page title

            ResumeRepository _ResumeRepository = new ResumeRepository();

            grdData.DataSource = _ResumeRepository.LoadByActiveState(true);
            grdData.DataBind();
        }
        #endregion
        #region Events
        ...
        {
            ResumeRepository _Obj = new ResumeRepository();

...
{
    public partial class SocialLinksList : System.Web.UI.Page
    {
        #region  Methods
        private void BindData()
        {
            MasterPages.Pages.PageTitle = "Social Links";   // Set page title

            SocialLinkRepository _SocialLinksRepository = new SocialLinkRepository();

            grdData.DataSource = _SocialLinksRepository.LoadByActiveState(true);
            grdData.DataBind();
        }
        ...
        {
            SocialLinkRepository _Obj = new SocialLinkRepository();
        ...
        {
            Response.Redirect("~/AdminPanale/MainPages/SocialLinksManagement.aspx");
        }
        #endregion

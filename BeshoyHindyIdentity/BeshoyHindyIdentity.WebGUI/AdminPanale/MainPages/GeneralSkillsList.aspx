<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="GeneralSkillsList.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.GeneralSkillsList" %>
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <asp:GridView ID="grdData"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="Title" HeaderText="Skill Title" SortExpression="Title">
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="btnEdit" runat="server"
                                                            CssClass="btn btn-default btn-sm btn-small"
                                                            NavigateUrl='<%#"~/AdminPanale/MainPages/GeneralSkillsMaganagement.aspx?ID="+Eval("id")%>'
                                                            data-toggle="tooltip"
                                                            title="Edit Item"
                                                            data-placement="bottom"
                                                            Text="Edit">
                                        ...
                                        <div>
                                            <asp:GridView ID="grdData2" runat="server">

<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="SocialLinksList.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.SocialLinksList" %>
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <asp:GridView ID="grdData"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="Title" HeaderText="Social Link Title" SortExpression="title">
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="btnEdit" runat="server"
                                                            CssClass="btn btn-default btn-sm btn-small"
                                                            NavigateUrl='<%#"~/AdminPanale/MainPages/SocialLinksMaganagement.aspx?ID="+Eval("id")%>'
                                                            data-toggle="tooltip"
                                                            title="Edit Item"
                                                            data-placement="bottom"
                                                            Text="Edit">

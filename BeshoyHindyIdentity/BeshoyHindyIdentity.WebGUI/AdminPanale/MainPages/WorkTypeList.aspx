<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanale/MasterPages/Pages.Master" AutoEventWireup="true" CodeBehind="WorkTypeList.aspx.cs" Inherits="WebGUI.AdminPanale.MainPages.WorkTypeList" %>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HyperLink ID="btnEdit" runat="server"
                                                            CssClass="btn btn-default btn-sm btn-small"
                                                            NavigateUrl='<%#"~/AdminPanale/MainPages/WorkTypeMaganagement.aspx?ID="+Eval("id")%>'
                                                            data-toggle="tooltip"
                                                            title="Edit Item"
                                                            data-placement="bottom"
                                                            Text="Edit">

...
namespace WebGUI.AdminPanale.MainPages
{
    public partial class ProcessList : System.Web.UI.Page
    {
        ...
        {
            MasterPages.Pages.PageTitle = "Process";   // Set page title

            ProcessRepository _ProcessRepository = new ProcessRepository();

            grdData.DataSource = _ProcessRepository.LoadByActiveState(true);
            grdData.DataBind();
        }
        ...
        {
            ProcessRepository _Obj = new ProcessRepository();
        ...
        {
            Response.Redirect("~/AdminPanale/MainPages/ProcessManagement.aspx");
        }

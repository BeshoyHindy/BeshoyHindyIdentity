...
{
    public partial class AboutMeList : System.Web.UI.Page
    {
        #region  Methods
        private void BindData()
        {
            MasterPages.Pages.PageTitle = "About Me";   // Set page title

            AboutMeRepository _AboutMeRepository = new AboutMeRepository();

            grdData.DataSource = _AboutMeRepository.LoadByActiveState(true);
            grdData.DataBind();
        }
        ...
        {
            AboutMeRepository _Obj = new AboutMeRepository();

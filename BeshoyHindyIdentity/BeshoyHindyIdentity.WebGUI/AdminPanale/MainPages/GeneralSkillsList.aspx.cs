...
{
    public partial class GeneralSkillsList : System.Web.UI.Page
    {
        #region  Methods
        private void BindData()
        {
            MasterPages.Pages.PageTitle = "General Skills";   // Set page title

            GeneralSkillRepository _GeneralSkillRepository = new GeneralSkillRepository();

            grdData.DataSource = _GeneralSkillRepository.LoadByActiveState(true);
            grdData.DataBind();
        }
        ...
        {
            GeneralSkillRepository _Obj = new GeneralSkillRepository();
